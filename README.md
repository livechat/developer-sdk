...
The `Developer-SDK` is a part of the LiveChat Developer Studio and its main purpose is to arm your project with tooling that optimizes usage of `LiveChat Developer Platform` ecosystem.
